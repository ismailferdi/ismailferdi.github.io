...
const DetailedSkillCard = ({ title, icon: Icon, items, accent }: { title: string, icon: any, items: { skill: string, desc: string, tag?: 'basics' | 'learning' }[], accent?: boolean }) => (
  <div 
    className={`glass-card p-8 flex flex-col gap-5 hover:scale-[1.02] ${accent ? 'border-primary/40 bg-primary/[0.04]' : ''}`}
  >
    ...
    <div className="space-y-2.5">
      {items.map(({ skill, desc, tag }) => (
        <div key={skill} className="text-sm leading-relaxed">
          <span className="font-bold text-body-strong">{skill}</span>
          <span className="text-muted"> — {desc}</span>
          {tag === 'basics' && <span className="text-[10px] text-muted-soft italic ml-1">(basics)</span>}
    ...
    <div className="min-h-screen selection:bg-primary/30 selection:text-primary">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="flex flex-col-reverse md:flex-row md:items-start md:gap-8 lg:gap-16">
            <div className="flex-1 space-y-8">
              <h1 className="font-serif font-medium text-6xl md:text-7xl tracking-tight text-on-dark animate-fade-in">
                ISMAIL FERDI
              </h1>
      ...
      <main className="max-w-5xl mx-auto px-6 pb-24 space-y-32">
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="glass-card p-8 space-y-6">
              ...
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <h3 className="text-2xl font-bold tracking-tight text-on-dark">ChurnOps — Customer Churn Prediction Pipeline</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">API Endpoints</p>
                ...
                <div>
                  <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">Key Features</p>
                  <ul className="space-y-2 text-sm text-body">
                    {[
            ...
            <div className="glass-card p-8 space-y-6">
              <RAGFlow />
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <h3 className="text-2xl font-bold tracking-tight text-on-dark">RAGNar — RAG-Powered Document Q&A System</h3>
                <span className="badge-brand flex-shrink-0">Shipped</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">Pipeline Stages</p>
                  <ul className="space-y-2 text-sm text-body">
                    {[
            ...
            <div className="glass-card p-8 space-y-6">
              <ETLFlow />
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <h3 className="text-2xl font-bold tracking-tight text-on-dark">Banks ETL — Largest-Banks Data Pipeline</h3>
                <span className="badge-brand flex-shrink-0">Shipped</span>
              </div>
        ...
        <section id="education">
          ...
          <div className="space-y-12">
            ...
            <div className="glass-card p-8">
              <h3 className="text-[10px] font-black text-muted uppercase tracking-[0.2em] mb-4">Education</h3>
            ...
            <div className="glass-card p-8">
              <h3 className="text-[10px] font-black text-muted uppercase tracking-[0.2em] mb-4">Certifications</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="text-[10px] font-bold text-muted uppercase tracking-widest border-b border-hairline">
        ...
        <section id="contact">
          ...
          <div className="mb-12">
            <h2 className="font-serif font-medium tracking-tight text-4xl text-ink mb-4">Let's Connect</h2>
      ...
      <footer className="mt-24 py-16 px-6 bg-surface-brand-elevated text-center">
